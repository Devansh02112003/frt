...
<body style="background-color:black;" >>
  <header class="title-font sm:text-4xl text-3xl mt-20 mb-4 font-medium text-white text-center">
    Create An Account
  </header>
  <section class="text-white body-font">
    <div class="container px-5 py-5 mx-auto">
      <div class="border border-white bg-black rounded-lg p-8 flex flex-col items-inline block w-full mt-10 mb-12">
        <form action="" method="post" >
        <h2 class="text-white text-lg font-medium text-center title-font mb-5">Sign Up</h2>
        <div class="relative mb-4">
          ...
          <input type="text" id="Full Name" name="fname" placeholder="Enter Your Hospital Name"
            class="w-full bg-black rounded border border-white focus:border-white focus:ring-2 focus:ring-purple-200 text-base outline-none text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
        </div>
        <div class="relative mb-4">
          ...
          <input type="text" id="Full Name" name="address" placeholder="Enter Your Hospital Address"
            class="w-full bg-black rounded border border-white focus:border-white focus:ring-2 focus:ring-white text-base outline-none text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
        </div>
        <div class="relative mb-4">
        ...
        <div class="relative mb-4">
          ...
          <input type="password" id="Re-Password" name="Password" placeholder="Re-enter Your Password"
            class="w-full bg-black rounded border border-white focus:border-black focus:ring-2 focus:ring-black text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
        </div>
        <button onclick="on_signup()" value="Sign Up"
          class=" w-full text-white bg-gray-900 border-white py-2 px-8 focus:outline-none hover:bg-gray-500 rounded text-black">Sign
          Up</button>
