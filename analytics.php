...
<body style="background-color:black;">
    ...
    <section style="background-color:black;" class="home-section">
        <nav style="background-color:black;">
            <div class="sidebar-button text-white">
                <i class='bx bx-menu sidebarBtn'></i>
                <span class="dashboard text-white">Analytics</span>
            </div>
        ...
        <div style="background-color:black;" class="home-content">
            <div class="overview-boxes">
              <div style="background-color:black;" class="box text-white">
